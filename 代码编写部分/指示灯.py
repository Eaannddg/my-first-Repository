...
class MyPanel3 ( wx.Panel ):
	...
	def __init__( self, parent, id = wx.ID_ANY, pos = wx.DefaultPosition, size = wx.Size( 765,232 ), style = wx.TAB_TRAVERSAL, name = wx.EmptyString ):
		...
		self.volatge.SetFont( wx.Font( 12, wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_NORMAL, False, "宋体" ) )
		...
		self.current.SetFont( wx.Font( 12, wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_NORMAL, False, wx.EmptyString ) )
		...
		self.power.SetFont( wx.Font( 12, wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_NORMAL, False, wx.EmptyString ) )
		...
		self.m_staticline1 = wx.StaticLine( CH1.GetStaticBox(), wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize, wx.LI_VERTICAL )
		...
		self.voltageInput = wx.TextCtrl( CH1.GetStaticBox(), wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, 0 )
		...
		self.unit_of_V.SetFont( wx.Font( 12, wx.FONTFAMILY_ROMAN, wx.FONTSTYLE_ITALIC, wx.FONTWEIGHT_NORMAL, False, "Cambria" ) )

		current_voltage_setting.Add( self.unit_of_V, 0, wx.ALIGN_CENTER|wx.ALL, 5 )

		self.currentInput = wx.TextCtrl( CH1.GetStaticBox(), wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, 0 )
		...
		self.unit_of_A.SetFont( wx.Font( 12, wx.FONTFAMILY_ROMAN, wx.FONTSTYLE_ITALIC, wx.FONTWEIGHT_NORMAL, False, "Cambria" ) )
		...
		self.set_button.SetFont( wx.Font( 9, wx.FONTFAMILY_ROMAN, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_NORMAL, False, "Book Antiqua" ) )
		...
		self.ovp_value = wx.TextCtrl( CH1.GetStaticBox(), wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.Size( 150,-1 ), 0 )
		...
		self.unit_of_V1.SetFont( wx.Font( 12, wx.FONTFAMILY_ROMAN, wx.FONTSTYLE_ITALIC, wx.FONTWEIGHT_NORMAL, False, "Cambria" ) )
		...
		self.ocp_value = wx.TextCtrl( CH1.GetStaticBox(), wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.Size( 150,-1 ), 0 )
		...
		self.unit_of_A1.SetFont( wx.Font( 12, wx.FONTFAMILY_ROMAN, wx.FONTSTYLE_ITALIC, wx.FONTWEIGHT_NORMAL, False, "Cambria" ) )
		...
		self.m_staticline11 = wx.StaticLine( CH1.GetStaticBox(), wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize, wx.LI_VERTICAL )
		...
		self.m_staticText14 = wx.StaticText( CH1.GetStaticBox(), wx.ID_ANY, u"电源：", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_staticText14.Wrap( -1 )

		bSizer9.Add( self.m_staticText14, 0, wx.ALL, 5 )

		self.power_switch = wx.ToggleButton( CH1.GetStaticBox(), wx.ID_ANY, u"on/off", wx.DefaultPosition, wx.Size( 90,40 ), 0 )
		self.power_switch.SetFont( wx.Font( 18, wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_BOLD, False, "宋体" ) )
		...
		self.m_staticText141 = wx.StaticText( CH1.GetStaticBox(), wx.ID_ANY, u"ovp/ocp:", wx.DefaultPosition, wx.DefaultSize, 0 )
	...
	def set_overcurrent_protection_state(self, event):
		value = self.ocp_value.GetValue()
		self.DP932A_controller.set_overcurrent_protection_state(self.CH, value)
		event.Skip()
