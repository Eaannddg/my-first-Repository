...
class MyPanel3(wx.Panel):
    ...
    def __init__(self, parent, id=wx.ID_ANY, pos=wx.DefaultPosition, size=wx.Size(765, 232), style=wx.TAB_TRAVERSAL,
                 name=wx.EmptyString):
        wx.Panel.__init__(self, parent, id=id, pos=pos, size=size, style=style, name=name)

        CH1 = wx.StaticBoxSizer(wx.StaticBox(self, wx.ID_ANY, u"CH3"), wx.HORIZONTAL)
